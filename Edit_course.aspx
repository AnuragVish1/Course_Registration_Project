        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <div class="form-container">
                    ...
                    <div class="table-container">
                        <asp:GridView ID="gvSchedule" runat="server" CssClass="dynamic-table" AutoGenerateColumns="false" OnDataBound="gvSchedule_DataBound" OnRowDeleting="GvSchedule_Delete">
                            <Columns>
